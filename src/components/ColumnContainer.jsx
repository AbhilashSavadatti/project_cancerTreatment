...
function ColumnContainer({
  ...
  return (
    <div
      ref={setNodeRef}
      style={style}
      className="flex h-[500px] max-h-[500px] w-[350px] flex-col rounded-xl bg-[#ffff]"
    >
      <div
        {...attributes}
        {...listeners}
      ...
      <button
        className="flex text-white bg-black items-center gap-2 rounded-md border-2 border-columnBackgroundColor border-x-columnBackgroundColor p-4 hover:bg-mainBackgroundColor hover:text-green-500 active:bg-black"
        onClick={() => {
